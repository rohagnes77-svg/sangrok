...
const questions: Question[] = [
  ...
  { number: 16, title: '운동 후 정리운동의 효과로 옳은 것은?', options: ['혈액 정체를 예방하는 데 도움을 준다', '심박수를 급격히 높인다', '회복을 방해한다', '체온을 갑자기 낮춘다', '운동 효과를 모두 없앤다'], answer: 0, explanation: '정리운동은 운동 후 심박수와 혈액순환을 서서히 안정시켜 회복��� 돕습니다.' },
